...
if __name__ == "__main__":
    if slack_client.rtm_connect():
        print("TWG Bot connected and running!")
        ...
        while True:
            ...
            #print("user_id::: ",user_id," message_user::: ",message_user," message::: ",message," team::: ",team," channel::: ",channel)
            if message: # If a User has typed something in Slack
                ...
                print("coming out from handle_command:: ")
                #print("After context::: ",context)
                ...
                #print("before string_to_run")
                os.system(string_to_run)
                #print("after string_to_run")
